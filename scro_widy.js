...
function widy_character_go({direction='right',speed='30',position='',size='100px',width='100vw',media_url='https://webstockreview.net/images/clipart-dinosaur-dinosaur-extinction-18.gif'}={}){
